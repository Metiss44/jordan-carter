...
export const UserGroupIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.57-1.036 1.368-1.874 2.309-2.523m-8.135 4.542c.426-.953 1.023-1.823 1.79-2.543m12.474 4.542c.305-.51.556-1.054.757-1.623m-14.97 0a4.498 4.498 0 004.286-6.335m-4.286 6.335a4.498 4.498 0 01-4.286-6.335m12.012 6.335c-.38-.953-.994-1.823-1.79-2.543m1.79 2.543a4.5 4.5 0 004.285-6.335m-12.012 6.335c.17.43.38.835.634 1.224m-6.34-1.224a4.5 4.5 0 016.34-1.224m-4.5 0a4.5 4.5 0 00-2.25 6.335m12.012-6.335a4.5 4.5 0 012.25 6.335" />
  </svg>
);
